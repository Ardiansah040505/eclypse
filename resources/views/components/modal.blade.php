...
{{-- Modal: Atur Video YouTube (Multiple Videos) --}}
<div class="modal-overlay" id="modal-addvideo">
  <div class="modal-box" style="max-width:600px; max-height:90vh; overflow-y:auto;">
    <div class="modal-header">
      <div class="modal-title">🎬 Kelola Video Pembelajaran</div>
      <button class="modal-close" onclick="closeModal('modal-addvideo')">✕</button>
    </div>
    <div class="modal-form">
      <p style="font-size:0.85rem;color:var(--gray);margin-bottom:1rem">Tambahkan video YouTube untuk ditampilkan di Tahap 2. Mendukung beberapa video sekaligus.</p>

      {{-- Form Type Toggle --}}
      <div class="form-toggle mb-4" id="formTypeToggle">
        <button type="button" class="btn-sm" onclick="showSingleVideoForm()" id="btnSingleForm">📹 Satu Video</button>
        <button type="button" class="btn-sm" onclick="showMultipleVideoForm()" id="btnMultipleForm">📚 Banyak Video</button>
      </div>

      {{-- Single Video Form --}}
      <div id="singleVideoForm" style="display:none">
        ...
        <div style="margin-top:1rem">
          <button class="btn-sm green" onclick="saveVideo()">💾 Simpan Video</button>
        </div>
      </div>
      ...
      <div id="multipleVideoForm" style="display:none">
        ...
        <div style="margin-top:1rem">
          <button class="btn-sm green" onclick="saveMultipleVideos()">💾 Simpan Semua Video</button>
        </div>
      </div>

      {{-- Existing Videos List --}}
      <div class="mt-4" style="border-top:1px solid #e3e3e0;padding-top:1rem">
    ...
    <div style="padding:1rem;display:flex;gap:0.5rem;justify-content:flex-end;border-top:1px solid #e3e3e0">
      <button class="btn-sm" onclick="closeModal('modal-addvideo')">Tutup</button>
      <button class="btn-sm" style="background:#fee2e2;color:#dc2626" onclick="clearAllVideos()">🗑️ Hapus Semua</button>
    </div>
  </div>
</div>
